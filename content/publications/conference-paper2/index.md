...
summary: This paper presents a minimalist neural network for recognizing single- and multi-touch gestures on knitted capacitive smart textiles, achieving over 90% training and 80% testing accuracy. A comparative user study showed that participants quickly adapted to the textile interface and achieved performance comparable to a traditional trackpad, highlighting its technical viability and usability for real-world applications.
